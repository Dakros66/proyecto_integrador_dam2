...
import com.example.rracancoj.pintegrador.MainClassActivity;
import com.example.rracancoj.pintegrador.R;
import com.example.rracancoj.pintegrador.RegisterActivity;
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChild(user_id)){
                    startActivity(new Intent(LoginActivity.this, MainClassActivity.class));
                }else {
