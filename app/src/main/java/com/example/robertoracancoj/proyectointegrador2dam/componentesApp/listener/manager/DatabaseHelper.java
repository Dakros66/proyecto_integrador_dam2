...
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.listener.OnObjectChangedListener;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.listener.OnProfileCreatedListener;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.modelo.Comentario;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.modelo.PostListResult;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.modelo.Profile;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.vista.ApplicationHelper;
import com.example.robertoracancoj.proyectointegrador2dam.componentesApp.vista.Constants;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
            ...
            getProfileSingleValue(currentUserId, new OnObjectChangedListener<Profile>() {
                ...
                public void onObjectChanged(Profile obj) {
                    if(obj != null) {
                        ...
                        Log.e(TAG, "updateRegistrationToken",
    ...
    public void createComment(String commentText, final String postId, final OnTaskCompleteListener onTaskCompleteListener) {
        try {
            ...
            Comentario comentario = new Comentario(commentText);
            comentario.setId(commentId);
            comentario.setAuthorId(authorId);

            mCommentsReference.child(commentId).setValue(comentario, new DatabaseReference.CompletionListener() {
                @Override
                ...
                private void incrementCommentsCount(String postId) {
                    ...
                    postRef.runTransaction(new Transaction.Handler() {
                        ...
                        @Override
                        public void onComplete(DatabaseError databaseError, boolean b, DataSnapshot dataSnapshot) {
                            Log.i(TAG, "Updating comments count transaction is completed.");
    ...
    public void getPostList(final OnPostListChangedListener<Post> onDataChangedListener, long date) {
        ...
        postsQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Log.e(TAG, "getPostList(), onCancelled", new Exception(databaseError.getMessage()));
    ...
    public void getPostListByUser(final OnDataChangedListener<Post> onDataChangedListener, String userId) {
        ...
        postsQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Log.e(TAG, "getPostListByUser(), onCancelled", new Exception(databaseError.getMessage()));
            }
        });
    }
    ...
    public ValueEventListener getPost(final String id, final OnPostChangedListener listener) {
        ...
        ValueEventListener valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Log.e(TAG, "getPost(), onCancelled", new Exception(databaseError.getMessage()));
            }
        });
    ...
    public void getSinglePost(final String id, final OnPostChangedListener listener) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Log.e(TAG, "getSinglePost(), onCancelled", new Exception(databaseError.getMessage()));
            }
        });
    }
    ...
    public ValueEventListener getCommentsList(String postId, final OnDataChangedListener<Comentario> onDataChangedListener) {
    ...
    public void isPostExistSingleValue(String postId, final OnObjectExistListener<Post> onObjectExistListener) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Log.e(TAG, "isPostExistSingleValue(), onCancelled", new Exception(databaseError.getMessage()));
            }
        });
    }
